...
namespace Completed
{
	...
	public class Player : MovingObject
	{
        ...
        public Vector2 lastMovedDirection;          //last direction that the player moved
		...
		private void Update ()
		{
            ...
            if (shoot)
            {
                ...
                if (weapon != null)
                {
                    animator.SetTrigger("playerShootStrait");
		...
		protected override void AttemptMove <T> (int xDir, int yDir)
		{
            ...
            lastMovedDirection = new Vector2(xDir, yDir);
		...
		private void OnTriggerEnter2D (Collider2D other)
		{
            ...
            //Check if the tag of the trigger collided with is a Key.
